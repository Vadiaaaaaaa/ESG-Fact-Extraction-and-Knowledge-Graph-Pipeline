...
| Renewable energy share at Sanand unit | energy_consumption_per_unit | 0.470 | company_specific | keep_company_specific_provisional | auto_keep_company_specific | renewable_energy_share_at_sanand_unit | no match, mint from metric_core |
