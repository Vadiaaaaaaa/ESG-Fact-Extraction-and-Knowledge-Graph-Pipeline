"""Neo4j knowledge graph loader for Nestle India CY2021."""
...
DOC_ID       = "nestle_india_fy2021"
PASS2_PATH   = OUTDIR / "nestle_india_2021_pass2_rerun.json"
CHUNKS_PATH  = OUTDIR / "nestle_india_2021_rerun_fast_chunks.json"
...
def seed_company_doc(session) -> None:
    ...
    session.run(
        ...
        "    d.has_brsr=false, d.calendar='calendar_year'",
