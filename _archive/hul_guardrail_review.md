...
- human_review: 52
- review_or_alias_existing_canonical: 16
- review_existing_mapping: 11
- route_to_financial_registry_or_ignore: 9
- add_canonical: 4

## Automation Status

- needs_human_review: 79
- auto_route_financial: 9
- candidate_canonical: 4

## Action Queue Counts

- Rows needing action: 83
- needs_human_review: 79
- candidate_canonical: 4
...
| recycled plastic | recycled_plastic_content_share | 0.749 | near_miss | review_existing_mapping | needs_human_review | recycled_plastic_content_share | ambiguous match, margin too small |
...
| stores enrolled on Shikhar | distribution_reach | 0.431 | universal_gap | add_canonical | candidate_canonical | distribution_reach | no match, mint from metric_core |
...
| zero emissions commitment | scope_3_emissions_intensity | 0.306 | needs_review | human_review | needs_human_review | zero_emissions_commitment | no match, mint from metric_core |
...
| employees trained | employee_training_coverage | 0.681 | near_miss | review_existing_mapping | needs_human_review | employee_training_coverage | ambiguous match, margin too small |
...
| young people equipped with skills | employee_training_coverage | 0.357 | needs_review | human_review | needs_human_review | young_people_equipped_with_skills | no match, mint from metric_core |
| sustainable sourcing of agricultural crops | sustainable_sourcing_share | 0.691 | near_miss | review_existing_mapping | needs_human_review | sustainable_sourcing_share | ambiguous match, margin too small |
| recycled plastic | recycled_plastic_content_share | 0.778 | near_miss | review_existing_mapping | needs_human_review | recycled_plastic_content_share | ambiguous match, margin too small |
| food waste | food_waste_rate | 0.694 | near_miss | review_existing_mapping | needs_human_review | food_waste_rate | ambiguous match, margin too small |
...
| sustainable tomato sourcing | sustainable_sourcing_share | 0.663 | near_miss | review_existing_mapping | needs_human_review | sustainable_sourcing_share | ambiguous match, margin too small |
...
| plastic packaging | plastic_waste_collected | 0.656 | near_miss | review_existing_mapping | needs_human_review | plastic_waste_collected | ambiguous match, margin too small |
| plastic packaging | recycled_plastic_content_share | 0.620 | near_miss | review_or_alias_existing_canonical | needs_human_review | recycled_plastic_content_share | no match, mint from metric_core |
...
| waste pickers | plastic_waste_collected | 0.579 | near_miss | review_or_alias_existing_canonical | needs_human_review | plastic_waste_collected | no match, mint from metric_core |
...
| patients treated | plastic_waste_collected | 0.507 | needs_review | human_review | needs_human_review | patients_treated | no match, mint from metric_core |
| people reached | distribution_reach | 0.519 | needs_review | human_review | needs_human_review | people_reached | no match, mint from metric_core |
| Domex disinfectant products | distribution_reach | 0.317 | needs_review | human_review | needs_human_review | domex_disinfectant_products | no match, mint from metric_core |
...
| sustainable tomato sourcing | sustainable_sourcing_share | 0.674 | near_miss | review_existing_mapping | needs_human_review | sustainable_sourcing_share | ambiguous match, margin too small |
...
| reach | distribution_reach | 0.508 | needs_review | human_review | needs_human_review | reach | no match, mint from metric_core |
...
| wall paintings | markets_operating_in | 0.369 | needs_review | human_review | needs_human_review | wall_paintings | no match, mint from metric_core |
...
| employment generated | employee_headcount | 0.470 | needs_review | human_review | needs_human_review | employment_generated | no match, mint from metric_core |
...
| waste prevented | plastic_waste_collected | 0.601 | near_miss | review_or_alias_existing_canonical | needs_human_review | plastic_waste_collected | no match, mint from metric_core |
...
| environment friendly cloth bags | plastic_waste_collected | 0.499 | needs_review | human_review | needs_human_review | environment_friendly_cloth_bags | no match, mint from metric_core |
