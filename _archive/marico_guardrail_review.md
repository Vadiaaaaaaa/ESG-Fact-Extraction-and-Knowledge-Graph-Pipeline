...
| GHG emission intensity (Scope 1+2) | combined_scope_1_2_emissions_intensity | 0.743 | near_miss | review_existing_mapping | needs_human_review | combined_scope_1_2_emissions_intensity | ambiguous match, margin too small |
...
| Post-consumer plastic waste collected and recycled | plastic_waste_collected | 0.800 | near_miss | review_existing_mapping | needs_human_review | plastic_waste_collected | ambiguous match, margin too small |
...
| network reach | distribution_reach | 0.617 | near_miss | review_existing_mapping | needs_human_review | distribution_reach | no match, mint from metric_core |
