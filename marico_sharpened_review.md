...
- candidate_canonical: 5

## Action Queue Counts

- Rows needing action: 23
- needs_human_review: 18
- candidate_canonical: 5
...
| Market Capitalisation | working_capital | 0.451 | out_of_operational_scope | route_to_financial_registry_or_ignore | auto_route_financial | market_capitalisation | no match, mint from metric_core |
...
| GHG emission intensity (Scope 1+2) | combined_scope_1_2_emissions_intensity | 0.785 | near_miss | review_existing_mapping | needs_human_review | combined_scope_1_2_emissions_intensity | ambiguous match, margin too small |
| Scope 1 & Scope 2 GHG Emission Intensity FY24 | combined_scope_1_2_emissions_intensity | 0.785 | near_miss | review_existing_mapping | needs_human_review | combined_scope_1_2_emissions_intensity | ambiguous match, margin too small |
| Operational water consumption intensity reduction | water_reduction_vs_baseline | 0.748 | near_miss | review_existing_mapping | needs_human_review | water_reduction_vs_baseline | ambiguous match, margin too small |
...
| Water conservation at Puducherry unit | water_reduction_vs_baseline | 0.745 | near_miss | review_existing_mapping | needs_human_review | water_reduction_vs_baseline | ambiguous match, margin too small |
...
| Recycled plastic (PCR) | recycled_plastic_content_share | 0.789 | near_miss | review_existing_mapping | needs_human_review | recycled_plastic_content_share | ambiguous match, margin too small |
