...
class ExtractedFact:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ExtractedFact":
        return cls(
            ...
            period_confidence=data.get("period_confidence", ""),
            fact_type=data.get("fact_type", "measurement"),
            ...
            rescue_pass=data.get("rescue_pass", False),
            rescue_result=data.get("rescue_result", ""),
            duplicate_chunk_ids=list(data.get("duplicate_chunk_ids") or []),
            raw=data.get("raw", {}),
        )
