...
| stores enrolled on Shikhar | store_traffic | 0.449 | universal_gap | add_canonical | candidate_canonical | distribution_reach | no match, mint from metric_core |
...
| workforce with disabilities | female_workforce_share | 0.515 | needs_review | human_review | needs_human_review | workforce_with_disabilities | no match, mint from metric_core |
...
| service camps | consumer_engagement | 0.362 | needs_review | human_review | needs_human_review | service_camps | no match, mint from metric_core |
