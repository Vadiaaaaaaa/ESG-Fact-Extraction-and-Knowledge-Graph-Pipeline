...
| recycled plastic | recycled_plastic_content_share | 0.701 | near_miss | review_existing_mapping | needs_human_review | recycled_plastic_content_share | ambiguous match, margin too small |
...
| recycled plastic | recycled_plastic_content_share | 0.727 | near_miss | review_existing_mapping | needs_human_review | recycled_plastic_content_share | ambiguous match, margin too small |
...
| plastic packaging | packaging_recyclability | 0.672 | near_miss | review_existing_mapping | needs_human_review | packaging_recyclability | ambiguous match, margin too small |
| plastic packaging | packaging_recyclability | 0.676 | near_miss | review_existing_mapping | needs_human_review | packaging_recyclability | ambiguous match, margin too small |
